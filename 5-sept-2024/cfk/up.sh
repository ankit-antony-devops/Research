...
# Start local k8s cluster with minikube
echo "Starting local k8s cluster with minikube"
minikube start --cpus='max' --memory=10240 --addons=metrics-server --kubernetes-version=v1.26.3
